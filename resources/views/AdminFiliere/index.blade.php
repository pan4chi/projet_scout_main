...
<br>
                        <center>
                <h1>Bienvenue cher Admin , veuillez utiliser le menu pour mieux naviguer !!!</h1>
                @if(Auth::check())
                    ...
                    <ul class="menu-list"> 
                        ...
                        <li class="">
                            <a href="{{ route('filiere.activity.addform') }}">
                                <span class="icon"><i class="mdi mdi-square-edit-outline"></i></span>
                                <span class="menu-item-label">Ajouter une Activité</span>
                            </a>
                        </li> 
                        ...
                        <ul class="menu-list">
                            <li class="">
                                ...
                                <a href="#" onclick="document.getElementById('log_out').submit()">
                                    ...
                                    <span class="menu-item-label">Déconnexion</span>
                                </a>
                            </li>
                        </ul>
