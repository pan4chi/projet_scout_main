            ...
            <table>
                ...
                <tr>
                    ...
                    <td for="Les_membres_du_personnel_impliqués[]">
                        <select name="Les_membres_du_personnel_impliqués[]" id="membres_select">
                            @foreach($members as $member)
                                <option value="{{ $member->id }}">{{ $member->Nom_complet_en_arabe }}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <th for="member_id">Membres</th>
                    <td for="member_id"><input type="number" name="member_id" id="member_id_input" required></td>
                </tr>
            </table>
