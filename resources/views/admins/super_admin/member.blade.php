            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Boutons d'action -->
                        <div>
                            <a href="{{ route('members_super.show', $member) }}" class="btn-action show">Afficher</a>
                            <a href="{{ route('members_super.edit', $member) }}" class="btn-action edit">Modifier</a>
                            <form action="{{ route('members_super.destroy', $member) }}" method="POST" style="display: inline-block;">
                                @csrf
                                @method('DELETE')
